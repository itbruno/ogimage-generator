...
function Home() {
  ...
  const [image, setImage] = useState(
    'https://images.unsplash.com/photo-1667611209964-3e1ff3394a35?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80'
  );
